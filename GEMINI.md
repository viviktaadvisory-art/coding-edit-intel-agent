...
### Phase 3.5: Data Ingestion (RAG)
Run `agents-cli infra single-project` then `agents-cli data-ingestion`. See the **Evaluation Guide** for RAG-specific evaluation criteria.
